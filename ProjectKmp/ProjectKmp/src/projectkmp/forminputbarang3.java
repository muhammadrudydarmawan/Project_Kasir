 ...
 * @author ROG
 */
public class forminputbarang3 extends javax.swing.JFrame {
...
AutoNokode();
    ...
    public void loadData() {
        ...
        try {
            ...
            String sql = "SELECT * FROM tbl_barang3";
     ...
     */
     private void AutoNokode() {
         try {
            ...
            ResultSet rs = st.executeQuery("Select * from tbl_barang3");
            while (rs.next()) {
...
System.out.println(e.getStackTrace());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Input Barang Stand 3");
    ...
    private void bsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsimpanActionPerformed
        ...
        if(tkdbarang.getText().equals("") ||tnamabarang.getText().equals("") || thargajual.getText().equals("")){
            ...
            try {
                ...
                String sql = "INSERT INTO tbl_barang3 VALUES (?, ?, ?)";
 ...
 //               p.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(forminputbarang3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
