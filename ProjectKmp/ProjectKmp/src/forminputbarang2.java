 ...
 * @author ROG
 */
public class forminputbarang2 extends javax.swing.JFrame {
    ...
    public void loadData() {
        ...
        try {
            ...
            String sql = "SELECT * FROM tbl_barang2";
     ...
     */
     private void AutoNokode() {
         try {
            ...
            ResultSet rs = st.executeQuery("Select * from tbl_barang2");
            while (rs.next()) {
...
System.out.println(e.getStackTrace());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Input Barang Stand 2");
    ...
    private void bsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsimpanActionPerformed
        ...
        if(tkdbarang.getText().equals("") ||tnamabarang.getText().equals("") || thargajual.getText().equals("")){
            ...
            try {
                ...
                String sql = "INSERT INTO tbl_barang2 VALUES (?, ?, ?)";
 ...
 //               p.close();
    ...
    private void bhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhapusActionPerformed
        // TODO add your handling code here:
         try {
            String sql ="delete from tbl_barang2 where kd_barang='"+tkdbarang.getText()+"'";
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        ...
        try {
            Connection c = ConnectionHelper.getConnection();
            String sql = "UPDATE  tbl_barang2 SET nama_barang =  '" + tnamabarang.getText() +  "', harga_jual='"+ thargajual.getText() +"' WHERE  kd_barang ='" + tkdbarang.getText() + "'";
            PreparedStatement p = c.prepareStatement(sql);
            p.executeUpdate();
            p.close();
        } catch (SQLException e) {
    ...
    private void tcariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tcariKeyReleased
        ...
        try {
            ...
            String sql = "select * from tbl_barang2 where kd_barang like '%" + tcari.getText() + "%' or nama_barang like'%" + tcari.getText() + "%' " + "or harga_jual like'%" + tcari.getText() + "%'";
            ResultSet r = s.executeQuery(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(forminputbarang2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
